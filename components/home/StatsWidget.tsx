...
export const StatsWidget: React.FC<StatsWidgetProps> = ({ isAuthenticated, className = '' }) => {
  ...
  return (
    <div className={`bg-white/40 dark:bg-black/40 backdrop-blur-3xl border border-white/40 dark:border-white/10 shadow-sm dark:shadow-2xl rounded-[2.5rem] p-8 flex flex-col justify-between h-full min-h-[220px] relative overflow-hidden group ${className}`}>
